  ...
  return (
    <>
      ...
      <div style={{ background: 'linear-gradient(90deg, #ff3333, #7f0000)', color: '#fff', padding: '0.5rem 1rem', textAlign: 'center', fontSize: '0.85rem', fontWeight: 600, letterSpacing: '0.5px', borderBottom: '1px solid rgba(255,255,255,0.1)', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '0.5rem' }}>
        ...
        <a onClick={() => navigate('/osint-ciudadano')} style={{ textDecoration: 'underline', color: '#fff', marginLeft: '0.5rem', cursor: 'pointer' }}>{lang === 'ca' ? 'Saber més →' : lang === 'en' ? 'Learn more →' : 'Saber más →'}</a>
      </div>
          ...
          <div style={{ position: 'relative', display: 'flex', justifyContent: 'center' }}>
            <div className="glass-panel" style={{ position: 'relative', zIndex: 2, padding: '3rem', width: '100%', maxWidth: '400px' }}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                {/* Floating Agent Display using proper live-site icons */}
